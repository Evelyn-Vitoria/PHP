...
<body>
    ...
    <form action="recebe-aula10.php" method="post">
        ...
        <p>Bem-vindo ao Mundos Literários!<br>
            <br>
            Estamos empolgados por ter você aqui. Em nosso espaço, a magia da leitura ganha vida e cada livro abre portas para novas aventuras. Explore, descubra e compartilhe sua paixão pela literatura conosco.<br>
            <br>
            Para que possamos oferecer uma experiência personalizada e mantê-lo atualizado sobre novidades e eventos, por favor, deixe seus dados conosco. Sua próxima grande história começa aqui!<br>
            <br>
            Bem-vindo a uma jornada literária sem limites!
